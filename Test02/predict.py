...
class ObjectDetection:
    ...
    def __init__(self, model_filename):
        ...
        # create a new file name for the model merging the execution path and the model filename
        execution_path = os.getcwd()
        model_filename = os.path.join(execution_path, model_filename)
        # print the model file name location
